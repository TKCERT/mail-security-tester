...
argparser.add_argument("--spam-folder", "-j", nargs="+", help="Folder with spam messages in EML format")
argparser.add_argument("--malware-folder", "-w", nargs="+", help="Folder with malware samples that are sent as attachment")
